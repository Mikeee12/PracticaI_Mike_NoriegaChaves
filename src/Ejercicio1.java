...
public class Ejercicio1 {
    public static void main(String[] args) {
        ...
        //Utilizamos un do while para asi utilizar brakes cuando queramos que el programa pare si eso ocurre
        ...
        do {
            ...
            if (hipoteca) {
                ...
                System.out.println("Salgase de la pagina entonces aqui solo damos hipotecas:)");
                break;
            }

            // Utilizamos otro scanner para la segunda pregunta
            Scanner sc1 = new Scanner(System.in);
            System.out.println("\n¿Usted trabaja?Introduzca true(si) o false(no)");
        ...
        System.out.println("\n¿Cuanto dinero cuesta la vivienda que quiere comprar?");
        vivienda = sc2.nextInt();


        Scanner sc3 = new Scanner(System.in);
        System.out.println("\nIntroduzca el dinero que desea solicitar.Recuerde que no puede superar el 80% del precio de la vivienda");
        dinero = sc3.nextInt();

        //Ahora con un if le decimos que no puede superar el 80% del precio de la vivienda y dentro de ese if metemos otro if con la variable ahorrado para pedile al usuario que escriba cuanto dinero ahorrado tiene para que si es menos de un 20% de la vivienda no darle la hipoteca
        if (dinero <= vivienda*80/100 ) {

            System.out.println("Perfecto este dinero entra dentro de los limites establecidos.");
            System.out.println("\nAhora introduzca lo que tiene ahorrado que debe ser igual o superior al 20% del precio de la vivienda");
            ...
            if (ahorrado >= vivienda * 20 / 100) {
                ...
                System.out.println("No podemos darle el dinero ya que no cumple el requisito");
            }
